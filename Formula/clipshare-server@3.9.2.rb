class ClipshareServerAT392 < Formula
  desc "Lightweight tool for sharing clipboard across devices"
  homepage "https://github.com/thevindu-w/clip_share_server"
  url "https://github.com/thevindu-w/clip_share_server/releases/download/v3.9.2/clip_share_server-3.9.2-macos.zip"
  sha256 "070aba24d0801fa3ff74c913adeb07190ab4d5f61ab616b0157a2618d3c2f8d6"
