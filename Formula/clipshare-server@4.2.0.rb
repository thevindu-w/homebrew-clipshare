class ClipshareServerAT420 < Formula
  desc "Lightweight tool for sharing clipboard across devices"
  homepage "https://github.com/thevindu-w/clip_share_server"
  url "https://github.com/thevindu-w/clip_share_server/releases/download/v4.2.0/clip_share_server-4.2.0-macos.zip"
  sha256 "0c97c996dc6a9228a64a27df6ae7a3dc097d93823eb43a0a82291115469a537d"
