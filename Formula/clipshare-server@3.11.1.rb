class ClipshareServerAT3111 < Formula
  desc "Lightweight tool for sharing clipboard across devices"
  homepage "https://github.com/thevindu-w/clip_share_server"
  url "https://github.com/thevindu-w/clip_share_server/releases/download/v3.11.1/clip_share_server-3.11.1-macos.zip"
  sha256 "087bdbb3932efd632e772dcada7d7706b53742064f8e27f00e3b2cd3ecbeb3e1"
